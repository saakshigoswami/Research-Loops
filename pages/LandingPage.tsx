...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-indigo-100 overflow-x-hidden">
      <nav className="fixed top-0 w-full z-[100] bg-white/80 backdrop-blur-xl border-b border-slate-200/60 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6 lg:gap-8 flex-wrap">
            <button type="button" onClick={handleJoinAsSubject} className="hidden md:block text-sm font-bold text-slate-500 hover:text-indigo-600 transition-colors">Find a Study</button>
            <button type="button" onClick={handleJoinAsSubject} className="hidden md:block text-sm font-bold text-slate-500 hover:text-indigo-600 transition-colors">Trending</button>
            <button type="button" onClick={handleLaunchResearchLab} className="hidden md:block text-sm font-bold text-slate-500 hover:text-indigo-600 transition-colors">Post Research</button>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden animate-gradient-bg" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 25%, #312e81 50%, #1e1b4b 75%, #0f172a 100%)', backgroundSize: '200% 200%' }}>
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center pt-28 pb-32 px-6">
          <div className="lg:col-span-7">
            <div className="animate-fade-in-up animate-fade-in-up-1 inline-block bg-indigo-500/20 text-indigo-200 border border-indigo-400/30 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest mb-6">
              ✦ Now Powered by Gemini 3.0
            </div>
            <h1 className="landing-hero-title animate-fade-in-up animate-fade-in-up-2 text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white mb-8 leading-[0.95] tracking-tight">
            ...
            <p className="animate-fade-in-up animate-fade-in-up-3 text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed max-w-xl font-medium">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in-up animate-fade-in-up-4">
              <button type="button" onClick={handleLaunchResearchLab} className="relative overflow-hidden px-10 py-5 bg-white text-slate-900 rounded-2xl font-black text-lg shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 hover:bg-indigo-50 border border-white/20">
              ...
              <button type="button" onClick={handleJoinAsSubject} className="px-10 py-5 bg-transparent text-white rounded-2xl font-black text-lg border-2 border-indigo-400/60 hover:border-indigo-300 hover:bg-indigo-500/10 transition-all duration-300 hover:scale-[1.02]">
                Join as Subject
              </button>
            </div>
          </div>
          <div className="lg:col-span-5 relative hidden lg:block">
            <div className="animate-fade-in-up animate-fade-in-up-6 w-full aspect-square rounded-[4rem] overflow-hidden flex items-center justify-center p-12 border border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl">
              <div className="relative w-full h-full flex flex-col justify-center gap-4">
                <div className="w-48 h-12 bg-white/10 rounded-xl self-start p-4 flex items-center gap-3 border border-white/10 animate-float">
                  <div className="w-4 h-4 bg-indigo-400 rounded-full animate-pulse" />
                  <div className="h-2 w-24 bg-white/20 rounded" />
                </div>
                <div className="w-64 h-32 bg-gradient-to-br from-indigo-500/40 to-violet-500/40 rounded-[2rem] self-center p-6 flex flex-col justify-between border border-indigo-400/30 shadow-lg shadow-indigo-500/20">
                  <div className="h-3 w-12 bg-white/30 rounded" />
                  <div className="h-4 w-40 bg-white/20 rounded" />
                  <div className="h-2 w-24 bg-white/40 rounded self-end" />
                </div>
                <div className="w-48 h-12 bg-white/10 rounded-xl self-end p-4 flex items-center gap-3 border border-white/10 animate-float" style={{ animationDelay: '1s' }}>
      ...
      <section className="relative py-16 sm:py-20 bg-gradient-to-b from-slate-50 to-white border-t border-slate-100 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white rounded-2xl border-2 border-slate-100 p-6 sm:p-8 shadow-sm hover:shadow-lg hover:border-indigo-200 transition-all duration-300">
            ...
            <div className="bg-white rounded-2xl border-2 border-slate-100 p-6 sm:p-8 shadow-sm hover:shadow-lg hover:border-emerald-200 transition-all duration-300">
            ...
            <div className="bg-white rounded-2xl border-2 border-slate-100 p-6 sm:p-8 shadow-sm hover:shadow-lg hover:border-violet-200 transition-all duration-300">
            ...
            <div className="bg-white rounded-2xl border-2 border-slate-100 p-6 sm:p-8 shadow-sm hover:shadow-lg hover:border-amber-200 transition-all duration-300">
      ...
      <section className="relative py-24 bg-gradient-to-b from-white to-slate-50/50 border-t border-slate-100 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-black text-slate-900 mb-4 uppercase tracking-tighter landing-hero-title">Choose Your Vertical</h2>
            <div className="w-24 h-1 rounded-full bg-gradient-to-r from-indigo-500 to-amber-500 mx-auto" />
          </div>
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
          <div className="animate-fade-in-up feature-delay-1">
          ...
          <div className="animate-fade-in-up feature-delay-2">
            <div className="text-slate-900 font-black text-lg mb-4 flex items-center gap-3">
          ...
          <div className="animate-fade-in-up feature-delay-3">
            <div className="text-slate-900 font-black text-lg mb-4 flex items-center gap-3">
